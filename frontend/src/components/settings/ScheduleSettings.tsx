...
export default function ScheduleSettings() {
    return (
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center animate-in fade-in zoom-in duration-300">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-2">Schedule Settings</h2>
            <p className="text-gray-500 text-sm">Manage your availability and booking slots here.</p>
